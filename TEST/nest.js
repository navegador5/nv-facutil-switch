...
var entries = [//switch@root
    ...
    [
        ...
        [ //switch1@child
            ...
            [(r)=>r%7===1,          (r)=>r,             /*default:cmmn.break*/],  
    ...
    {handler:(r)=>'invalid-last', completion: cmmn.break /*default:cmmn.break*/}                      //default CASE of switch@root
]


var NestSwitch = creat_sync_nest_switch(entries,dflt_handler)
var switcher = new NestSwitch()
